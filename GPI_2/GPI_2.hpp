...
class GPI_2
{
  public:
    ...
    void set_fast_1_permission(uint32_t state) {
        ctl.write<reg::fast_1_permission>(state);
    }

    void set_fast_1_duration(uint32_t state) {
        ctl.write<reg::fast_1_duration>(state);
    }
    ...
    void set_fast_2_permission(uint32_t state) {
        ctl.write<reg::fast_2_permission>(state);
    }

    void set_fast_2_duration(uint32_t state) {
        ctl.write<reg::fast_2_duration>(state);
    }

    uint32_t get_W7X_timings() {
        return sts.read<reg::W7X_timings>();
    }
    ...
    uint32_t get_diff_gauge() {
     ...
     uint32_t get_slow_1_trigger_sts() {
        return sts.read<reg::slow_1_trigger_sts>();
    }
    
     uint32_t get_slow_2_trigger_sts() {
        return sts.read<reg::slow_2_trigger_sts>();
    }
         uint32_t get_slow_3_trigger_sts() {
        return sts.read<reg::slow_3_trigger_sts>();
    }
         uint32_t get_slow_4_trigger_sts() {
        return sts.read<reg::slow_4_trigger_sts>();
    }
