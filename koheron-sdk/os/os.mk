...
PROC := ps7_cortexa9_0
HSI := source $(HOME)/apps/Xilinx/Vivado/$(VIVADO_VERSION)/settings64.sh && hsi -nolog -nojournal -mode batch
BOOTGEN := source $(HOME)/apps/Xilinx/Vivado/$(VIVADO_VERSION)/settings64.sh && bootgen
...
$(TMP_OS_PATH)/fsbl/executable.elf: $(TMP_OS_PATH)/fsbl/Makefile $(FSBL_FILES)
	...
	source $(HOME)/apps/Xilinx/Vivado/$(VIVADO_VERSION)/settings64.sh && make -C $(@D) all
